...
import com.fooddelivery.customer.service.CustomerServiceImpl;
...
public class CustomerServiceImplTest {
    ...
    @Test
    public void testAddCustomers_Positive() throws DuplicateCustomerIDException {
    ...
    @Test
	public void testUpdateCustomer_Positive() throws CustomerNotFoundException {
	...
	@Test
	public void testDeleteCustomer_Positive() throws CustomerNotFoundException {
		int customerId=51;
	...
	@Test
	public void testFindByCustomerId_positive() throws CustomerNotFoundException {
	    ...
	    Customer actualCustomer = customerService.findById(existingCustomerId);
	    verify(customerRepository).findById(existingCustomerId);
	    assertEquals(expectedCustomer, actualCustomer);
	}
	@Test
	public void testFindByCustomerId_NotFound() throws CustomerNotFoundException {
