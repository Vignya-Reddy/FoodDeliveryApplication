...
public class MenuItemsServiceImplTest {
    ...
    @Test
    public void testAddMenuItems_Positive() throws CustomException {
    ...
    @Test
	public void testUpdateMenuItem_Positive() throws CustomException {
	    // Given
	...
	@Test
	public void testDeleteMenuItem_Positive() throws CustomException {
	    // Given
	    int itemId = 51;
	    MenuItems existingItem = new MenuItems(51, "Miso Soup", "Japanese soup with tofu and seaweed", 4.99);
